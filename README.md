...
<body>
    ...
    <div class="container">
        <h1 class="title hacker-effect" id="title">FELIZ DIA NEGRA❤️‍🩹</h1>
        <p class="message red" id="message1">POR SI AUN TUS MARIDOS NO TE HAN DADO TUS ROSITAS</p>
        <p class="message" id="message2">TENGO UN REGALO ESPECIAL PARA TI</p>
        
        <div class="button" id="button">
            <button class="btn" onclick="location.href='rosas.html'">
                VER TU REGALO
            </button>
        </div>
